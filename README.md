...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-mad-libs-f97316)](https://baditaflorin.github.io/mesh-mad-libs/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-mad-libs/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Multi-peer mad libs with blind slot fill and group reveal, no account, mesh-synced

Live: **https://baditaflorin.github.io/mesh-mad-libs/**

Source: **https://github.com/baditaflorin/mesh-mad-libs**
...
git clone https://github.com/baditaflorin/mesh-mad-libs
cd mesh-mad-libs
npm install
npm run dev
```
...
- `mesh-mad-libs:signalingUrl`
- `mesh-mad-libs:turnTokenUrl`
- `mesh-mad-libs:iceServers`
- `mesh-mad-libs:room`
